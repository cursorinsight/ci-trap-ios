...
final class SensorTests: XCTestCase {
    ...
    func testAccelerometer() throws {
        ...
        XCTAssertNotNil(TrapAccelerometerCollector.instance(withQueue: OperationQueue()))
    ...
    func testGravity() throws {
        ...
        XCTAssertNotNil(TrapGravityCollector.instance(withQueue: OperationQueue()))
        XCTAssertEqual(collector.checkConfiguration(), false)
        XCTAssertEqual(collector.checkPermission(), true)
    }
    ...
    func testGyroscope() throws {
        ...
        XCTAssertNotNil(TrapGyroscopeCollector.instance(withQueue: OperationQueue()))
        XCTAssertEqual(collector.checkConfiguration(), false)
        XCTAssertEqual(collector.checkPermission(), true)
    }
    ...
    func testMagnetometer() throws {
        ...
        XCTAssertNotNil(TrapMagnetometerCollector.instance(withQueue: OperationQueue()))
        XCTAssertEqual(collector.checkConfiguration(), false)
        XCTAssertEqual(collector.checkPermission(), true)
    }
}
